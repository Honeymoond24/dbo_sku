...
class ResetPasswords{
    ...
    public function __construct(){
        ...
        $this->mail->Port = 2525;
        $this->mail->Username = 'cd137fa25126dd';
        $this->mail->Password = '40f83befa2c9c6';
    }
    ...
    public function sendEmail(){
        ...
        $url = 'http://dbo/create-new-password.php?selector='.$selector.'&validator='.bin2hex($token);
        ...
        $this->mail->setFrom('APO9052@ku.edu.kz');
